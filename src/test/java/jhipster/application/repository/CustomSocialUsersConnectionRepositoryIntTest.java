...
import jhipster.application.TestingJHipsterApplicationApp;
import jhipster.application.domain.SocialUserConnection;
...
@SpringBootTest(classes = TestingJHipsterApplicationApp.class)
@Transactional
